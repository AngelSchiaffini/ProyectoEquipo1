...
-- DROP TABLE IF EXISTS Asistencia; DONE --Leer Datos para saber cuanto se ingreso
-- DROP TABLE IF EXISTS Usuario;--DONE
-- DROP TABLE IF EXISTS Pariente; -- DONE
-- DROP TABLE IF EXISTS Inventario; DONE --Leer
-- DROP TABLE IF EXISTS Estado; DONE--Leer
-- DROP TABLE IF EXISTS Condicion; DONE -- Estadisticas
-- DROP TABLE IF EXISTS Nacionalidad; Done-- Leer
-- DROP TABLE IF EXISTS Calificaciones; -- Leer
...
DROP DATABASE IF EXISTS ComedorBD;
